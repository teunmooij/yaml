...
const readFromFile = (fromPath) => __awaiter(void 0, void 0, void 0, function* () {
    const content = yield promises_1.default.readFile(fromPath, 'utf-8');
    return yaml.parse(content);
});
const readInput = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (fromFile && data)
        throw new Error('Please provide either from-file or data, not both');
    if (!fromFile && !data)
        throw new Error('Please provide either from-file or data');
    return {
        inputData: data ? JSON.parse(data) : yield readFromFile(path_1.default.join(process.env.GITHUB_WORKSPACE, fromFile)),
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { inputData, toFile } = yield readInput();
        //TODO: modifications
        const data = inputData;
        if (toFile) {
            promises_1.default.writeFile(toFile, yaml.stringify(data));
        }
